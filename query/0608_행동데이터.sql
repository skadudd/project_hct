...
SELECT 
    ...
    # 광고 조회
    COALESCE(adi.adImp_homeChg_ownedBanner,0) as adImp_homeChg_ownedBanner,
    COALESCE(adi.adImp_homeChg_adPopcorn,0) as adImp_homeChg_adPopcorn,
    COALESCE(adi.adImp_homeChg_adPie,0) as adImp_homeChg_adPie,
    COALESCE(adi.adImp_homeChg_mobion,0) as adImp_homeChg_mobion,
    COALESCE(adi.adImp_homeCash_coupang,0) as adImp_homeCash_coupang,
    COALESCE(adi.adImp_homeCash_adPopcorn,0) as adImp_homeCash_adPopcorn,
    COALESCE(adi.adImp_homeCash_adPie,0) as adImp_homeCash_adPie,
    COALESCE(adi.adImp_home_adPopcorn,0) as adImp_home_adPopcorn,
    COALESCE(adi.adImp_homeBottom_owned,0) as adImp_homeBottom_owned,
    COALESCE(adi.adImp_homeBottom_adPopcorn,0) as adImp_homeBottom_adPopcorn,
    COALESCE(adi.adImp_homeBottom_adPie,0) as adImp_homeBottom_adPie,
    COALESCE(adi.adImp_benefit_adPopcorn,0) as adImp_benefit_adPopcorn,
    COALESCE(adi.adImp_purchase_owned,0) as adImp_purchase_owned,
    COALESCE(adi.adImp_chgList_adPopcorn,0) as adImp_chgList_adPopcorn,
    COALESCE(adi.adImp_chgList_adPie,0) as adImp_chgList_adPie,
    COALESCE(adi.adImp_chg_owned,0) as adImp_chg_owned,
    COALESCE(adi.adImp_chg_adPopcorn,0) as adImp_chg_adPopcorn,
    COALESCE(adi.adImp_info_adPopcorn,0) as adImp_info_adPopcorn,
    COALESCE(adi.adImp_exit_adPie,0) as adImp_exit_adPie,
    COALESCE(adi.adImp_benefit_bongtu_adPopcorn,0) as adImp_benefit_bongtu_adPopcorn,
    COALESCE(adi.adImp_benefit_button_adPopcorn,0) as adImp_benefit_button_adPopcorn,
